/* Великий и могучий, но не идеальный - класс неографа и графа
* Реализованы методы:
* 1) Добавление вершины
* 2) Добавление и удаление ребра
* 3) Вывод списка смежности
* 4) Поиск всех компонент связности или компоненты связности конкретной вершины неографа
* 5) Алгоритм Косараджу-Шарира поиска компонент сильной связности ографа
...
* 13) Топологическая сортировка ографа
* 14) Поиск негативного цикла в ографе
* 15) Алгоритм Беллмана-Форда для ографа
* 16) Алгоритм Мура (SPFA) для ографа
* 17) Умный поиск кратчайшего пути в ациклическом ографе с произвольными весами
* 18) Алгоритм Флойда–Уоршелла для ографа
* 19) Алгоритм Джонсона для ографа
* 20) Чтобы добить 20ый пункт - генерация обратного ографа :)
* 
* Алгоритмы писались на основе приведенных ниже видеоуроков
* https://youtube.com/playlist?list=PLGhUJWLZ8uQ4EWdQwVyUFnz82kbeGRP97&si=vDfmSPmdLyKs7ueR
* https://youtube.com/playlist?list=PLGhUJWLZ8uQ69hYB-AtVCerJ5yqh_5awR&si=mVzYlSVh-mzMtRPN
*/
